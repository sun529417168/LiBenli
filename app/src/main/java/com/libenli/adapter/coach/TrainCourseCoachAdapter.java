...
public class TrainCourseCoachAdapter extends MyBaseAdapter {


    private ArrayList<TrainCourseCoachBean> listBean = new ArrayList<>();

    public TrainCourseCoachAdapter(Context context, List list) {
        super(context, list);
        listBean = (ArrayList<TrainCourseCoachBean>) list;
    }
    ...
    public void onInitView(View view, final int position) {
        ...
        name.setText(listBean.get(position).getProjectName());
    }
}
