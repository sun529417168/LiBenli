 ...
 * 版    本：V1.0.0
 */
public class MainCoachActivity extends BaseFragmentActivity {
    private Context context;
    private ViewPager viewPager;
    private FragmentPagerAdapter fragmentPagerAdapter;
    private static List<Fragment> fragmentList = new ArrayList<Fragment>();

    private ImageView dianDaoImage, rankImage, courseImage, mineImage;
    private TextView dianDaoText, rankText, courseText, mineText;
    private LinearLayout layout_dianDao, layout_rank, layout_course, layout_mine;
    ...
    private void changeBottom(int position) {
        ...
        courseImage.setImageResource(R.mipmap.course_nor);
        mineImage.setImageResource(R.mipmap.me_nor);
        /**
         * 文字
         */
        ...
        courseText.setTextColor(ContextCompat.getColor(context, R.color.gray));
        ...
        switch (position) {
            ...
            case 2:
                ...
                courseText.setTextColor(ContextCompat.getColor(context, R.color.blue));
                break;
            case 3:
                mineImage.setImageResource(R.mipmap.me_h);
    ...
    private void initView() {
         ...
         * 小图标
         */
        dianDaoImage = (ImageView) findViewById(R.id.main_coach_image_dianming);
        rankImage = (ImageView) findViewById(R.id.main_coach_image_rank);
        courseImage = (ImageView) findViewById(R.id.main_coach_image_course);
        mineImage = (ImageView) findViewById(R.id.main_coach_image_mine);
        /**
         * 文字
         */
        dianDaoText = (TextView) findViewById(R.id.main_coach_text_dianming);
        courseText = (TextView) findViewById(R.id.main_coach_text_course);
        rankText = (TextView) findViewById(R.id.main_coach_text_rank);
        mineText = (TextView) findViewById(R.id.main_coach_text_mine);

        /**
         * 点击布局控件
         */
        layout_dianDao = (LinearLayout) findViewById(R.id.main_coach_layout_dianming);
        layout_rank = (LinearLayout) findViewById(R.id.main_coach_layout_rank);
        layout_course = (LinearLayout) findViewById(R.id.main_coach_layout_course);
