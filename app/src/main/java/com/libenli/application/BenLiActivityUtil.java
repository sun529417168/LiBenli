 ...
 * 版    本：V1.0.0
 */
public class BenLiActivityUtil {
    ...
    private static BenLiActivityUtil instance;
    private long clickTime = 0; //记录第一次点击的时间

    private BenLiActivityUtil() {
     ...
     * @return
     */
    public static BenLiActivityUtil getInstance() {
        if (null == instance) {
            instance = new BenLiActivityUtil();
        }
        return instance;
